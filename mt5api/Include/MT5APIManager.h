...
//| Manager API version                                              |
//+------------------------------------------------------------------+
#define MTManagerAPIVersion  4540
#define MTManagerAPIDate     L"13 Sep 2024"
//+------------------------------------------------------------------+
//| Proxy description                                                |
//+------------------------------------------------------------------+
#pragma pack(push,1)
...
public:
   ...
   virtual MTAPIRES  LoggerOutString(const UINT code,LPCWSTR string)=0;
   ...
   virtual MTAPIRES  PositionRequestByLoginsSymbol(const UINT64 *logins,const UINT logins_total,LPCWSTR symbol,IMTPositionArray* positions)=0;
   ...
   virtual MTAPIRES  HistoryRequestByLoginsSymbol(const UINT64 *logins,const UINT logins_total,LPCWSTR symbol,const INT64 from,const INT64 to,IMTOrderArray* orders)=0;
   virtual MTAPIRES  HistoryRequestByGroupSymbol(LPCWSTR group,LPCWSTR symbol,const INT64 from,const INT64 to,IMTOrderArray* orders)=0;
   ...
   virtual MTAPIRES  DealRequestByLoginsSymbol(const UINT64 *logins,const UINT logins_total,LPCWSTR symbol,const INT64 from,const INT64 to,IMTDealArray* deals)=0;
   virtual MTAPIRES  DealRequestByGroupSymbol(LPCWSTR group,LPCWSTR symbol,const INT64 from,const INT64 to,IMTDealArray* deals)=0;
   ...
   virtual MTAPIRES  UserAccountGetByLogins(const UINT64 *logins,const UINT logins_total,IMTAccountArray* accounts)=0;
   virtual MTAPIRES  UserReserved5(void)=0;
   virtual MTAPIRES  UserReserved6(void)=0;
   virtual MTAPIRES  UserReserved7(void)=0;
   //--- trade orders database
   virtual MTAPIRES  OrderRequestByLoginsSymbol(const UINT64 *logins,const UINT logins_total,LPCWSTR symbol,IMTOrderArray* orders)=0;
   virtual MTAPIRES  OrderRequestByGroupSymbol(LPCWSTR group,LPCWSTR symbol,IMTOrderArray* orders)=0;
   virtual MTAPIRES  OrderCancel(const UINT64 ticket)=0;
   virtual MTAPIRES  OrderCancelBatch(const UINT64* tickets,const UINT tickets_total,MTAPIRES* results)=0;
   ...
   virtual UINT      LeverageTotal(void)=0;
   virtual MTAPIRES  LeverageNext(const UINT pos,IMTConLeverage* cfg)=0;
   ...
   virtual MTAPIRES  GeoResolve(LPCWSTR address,const UINT flags,IMTGeo* record)=0;
   virtual MTAPIRES  GeoResolveBatch(LPCWSTR* addresses,UINT addresses_total,const UINT flags,IMTGeo** records,MTAPIRES* results)=0;
...
public:
   ...
   virtual MTAPIRES  SymbolGroupShift(const UINT pos,const int shift)=0;
   virtual UINT      SymbolGroupTotal(void)=0;
   virtual MTAPIRES  SymbolGroupNext(const UINT pos,MTAPISTR &name)=0;
   ...
   virtual MTAPIRES  LeverageDelete(const UINT pos)=0;
   virtual MTAPIRES  LeverageShift(const UINT pos,const int shift)=0;
   virtual UINT      LeverageTotal(void)=0;
   virtual MTAPIRES  LeverageNext(const UINT pos,IMTConLeverage* cfg)=0;
   virtual MTAPIRES  LeverageGet(LPCWSTR name,IMTConLeverage* cfg)=0;
   virtual MTAPIRES  LeverageUpdateBatch(IMTConLeverage** configs,const UINT config_total,MTAPIRES* results)=0;
   virtual MTAPIRES  LeverageDeleteBatch(IMTConLeverage** configs,const UINT config_total,MTAPIRES* results)=0;
   virtual MTAPIRES  LeverageReserved1(void)=0;
   virtual MTAPIRES  LeverageReserved2(void)=0;
   virtual MTAPIRES  LeverageReserved3(void)=0;
   virtual MTAPIRES  LeverageReserved4(void)=0;
   ...
   virtual IMTGeo*   GeoCreate(void)=0;
   virtual MTAPIRES  GeoResolve(LPCWSTR address,const UINT flags,IMTGeo* record)=0;
   virtual MTAPIRES  GeoResolveBatch(LPCWSTR* addresses,const UINT addresses_total,const UINT flags,IMTGeo** records,MTAPIRES* results)=0;
   virtual MTAPIRES  GeoResolveReserved1(void)=0;
   virtual MTAPIRES  GeoResolveReserved2(void)=0;
   virtual MTAPIRES  GeoResolveReserved3(void)=0;
   virtual MTAPIRES  GeoResolveReserved4(void)=0;
