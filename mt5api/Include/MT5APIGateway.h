...
//-- Gateway API version
#define MTGatewayAPIVersion  4540
#define MTGatewayAPIDate     L"13 Sep 2024"
...
//--- check license
   MTAPIRES res=gateway->LicenseCheck(license_check);
...
//--- try to find library in PATH
   if(sizeof(void*)==4)
      wcsncpy_s(path,path_maxlen,L"MT5APIGateway.dll",_TRUNCATE);
   else
      wcsncpy_s(path,path_maxlen,L"MT5APIGateway64.dll",_TRUNCATE);
//--- ok
   return(true);
  }
//+------------------------------------------------------------------+
