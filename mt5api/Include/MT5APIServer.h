...
//| Server API version                                               |
//+------------------------------------------------------------------+
#define MTServerAPIVersion             4540
#define MTServerAPIDate                L"13 Sep 2024"
...
public:
   ...
   virtual MTAPIRES  CustomCommand(const UINT64 server_id,LPCVOID indata,const UINT indata_len,LPVOID& outdata,UINT& outdata_len)=0;
   virtual MTAPIRES  CustomCommand(const UINT64 server_id,IMTByteStream* indata,IMTByteStream* outdata)=0;
   ...
   virtual MTAPIRES  PositionGetByLoginsSymbol(const UINT64 *logins,UINT logins_total,LPCWSTR symbol,IMTPositionArray *positions)=0;
   ...
   virtual MTAPIRES  OrderGetByLoginsSymbol(const UINT64 *logins,UINT logins_total,LPCWSTR symbol,IMTOrderArray *orders)=0;
   ...
   virtual MTAPIRES  HistoryGetByGroupSymbol(LPCWSTR group,LPCWSTR symbol,INT64 from,INT64 to,IMTOrderArray *orders)=0;
   virtual MTAPIRES  HistoryGetByLoginsSymbol(const UINT64 *logins,UINT logins_total,LPCWSTR symbol,INT64 from,INT64 to,IMTOrderArray *orders)=0;
   ...
   virtual MTAPIRES  DealGetByGroupSymbol(LPCWSTR group,LPCWSTR symbol,INT64 from,INT64 to,IMTDealArray *deals)=0;
   virtual MTAPIRES  DealGetByLoginsSymbol(const UINT64 *logins,UINT logins_total,LPCWSTR symbol,INT64 from,INT64 to,IMTDealArray *deals)=0;
