...
public:
   ...
   virtual INT64     DateCreated(void) const=0;
   virtual MTAPIRES  DateCreated(const INT64 date)=0;
   //--- record modification date
   virtual INT64     DateModified(void) const=0;
   virtual MTAPIRES  DateModified(const INT64 date)=0;
