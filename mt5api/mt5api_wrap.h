...
class SwigDirector_IMTConHolidaySink : public IMTConHolidaySink
{
 public:
  SwigDirector_IMTConHolidaySink(int swig_p);
  void _swig_upcall_OnHolidayAdd(IMTConHoliday const *arg0) {
    IMTConHolidaySink::OnHolidayAdd(arg0);
  }
  virtual void OnHolidayAdd(IMTConHoliday const *arg0);
  void _swig_upcall_OnHolidayUpdate(IMTConHoliday const *arg0) {
    IMTConHolidaySink::OnHolidayUpdate(arg0);
  }
  virtual void OnHolidayUpdate(IMTConHoliday const *arg0);
  void _swig_upcall_OnHolidayDelete(IMTConHoliday const *arg0) {
    IMTConHolidaySink::OnHolidayDelete(arg0);
  }
  virtual void OnHolidayDelete(IMTConHoliday const *arg0);
  void _swig_upcall_OnHolidaySync() {
    IMTConHolidaySink::OnHolidaySync();
  }
  virtual void OnHolidaySync();
 private:
  intgo go_val;
  Swig_memory *swig_mem;
};

class SwigDirector_IMTConSymbolSink : public IMTConSymbolSink
{
 public:
  SwigDirector_IMTConSymbolSink(int swig_p);
  void _swig_upcall_OnSymbolAdd(IMTConSymbol const *arg0) {
    IMTConSymbolSink::OnSymbolAdd(arg0);
  }
  virtual void OnSymbolAdd(IMTConSymbol const *arg0);
  void _swig_upcall_OnSymbolUpdate(IMTConSymbol const *arg0) {
    IMTConSymbolSink::OnSymbolUpdate(arg0);
  }
  virtual void OnSymbolUpdate(IMTConSymbol const *arg0);
  void _swig_upcall_OnSymbolDelete(IMTConSymbol const *arg0) {
    IMTConSymbolSink::OnSymbolDelete(arg0);
  }
  virtual void OnSymbolDelete(IMTConSymbol const *arg0);
  void _swig_upcall_OnSymbolSync() {
    IMTConSymbolSink::OnSymbolSync();
  }
  virtual void OnSymbolSync();
  MTAPIRES _swig_upcall_HookSymbolAdd(UINT64 const arg0,IMTConSymbol *arg1) {
    return IMTConSymbolSink::HookSymbolAdd(arg0,arg1);
  }
  virtual MTAPIRES HookSymbolAdd(UINT64 const arg0,IMTConSymbol *arg1);
  MTAPIRES _swig_upcall_HookSymbolUpdate(UINT64 const arg0,IMTConSymbol const *arg1,IMTConSymbol *arg2) {
    return IMTConSymbolSink::HookSymbolUpdate(arg0,arg1,arg2);
  }
  virtual MTAPIRES HookSymbolUpdate(UINT64 const arg0,IMTConSymbol const *arg1,IMTConSymbol *arg2);
  MTAPIRES _swig_upcall_HookSymbolDelete(UINT64 const arg0,IMTConSymbol const *arg1) {
    return IMTConSymbolSink::HookSymbolDelete(arg0,arg1);
  }
  virtual MTAPIRES HookSymbolDelete(UINT64 const arg0,IMTConSymbol const *arg1);
 private:
  intgo go_val;
  Swig_memory *swig_mem;
};
